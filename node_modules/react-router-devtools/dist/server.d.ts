...
declare const defineServerConfig: (config: DevToolsServerConfig) => DevToolsServerConfig;

declare const withLoaderWrapper: (loader: (args: LoaderFunctionArgs) => Promise<any>, id: string) => (args: LoaderFunctionArgs | ActionFunctionArgs) => Promise<any>;
declare const withActionWrapper: (action: (args: ActionFunctionArgs) => Promise<any>, id: string) => (args: LoaderFunctionArgs | ActionFunctionArgs) => Promise<any>;
declare const withMiddlewareWrapper: (middlewares: any[], routeId: string) => any;
declare const withMiddlewareWrapperSingle: (middleware: any, routeId: string, index: number, middlewareName: string) => any;

export { defineServerConfig, withActionWrapper, withLoaderWrapper, withMiddlewareWrapper, withMiddlewareWrapperSingle };
