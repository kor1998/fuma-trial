...
var import_browser_external_node_path = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
function server(options = {}) {
	...
	function fileInfo(file, base) {
		...
		return {
			path: file,
			fullPath: import_browser_external_node_path.join(base, file)
		};
	}
...
function createDocMethods(info, load) {
	return {
		info,
		async getText(type) {
			if (type === "raw") return await (await import("./promises-ENWK4ViQ.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).readFile(info.fullPath, "utf-8");
...
//# sourceMappingURL=fumadocs-mdx_runtime_server.js.map